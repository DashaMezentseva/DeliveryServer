...
import mezentseva.com.android.deliveryserver.Model.Food;
import mezentseva.com.android.deliveryserver.ViewHolder.FoodViewHolder;
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                    ...
                    foodList.child(key).setValue(item); //!!!!!!!!!foodList.child(key).setValue(newFood);
